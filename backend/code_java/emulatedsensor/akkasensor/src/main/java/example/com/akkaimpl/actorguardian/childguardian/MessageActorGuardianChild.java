...
public abstract class MessageActorGuardianChild extends LoggerImpl<ActorGuardianChild> {
    protected MessageActorGuardianChild(){
        super(ActorGuardianChild.class);
    }
